...
export const DARK_PRESETS: ThemePreset[] = [
  { name: 'IMX Coral', accent: '#fb923c', accent2: '#2dd4bf', bg: '#0b0d10', bg2: '#14181f', surface: '#1c222c', text: '#f3f5f8', muted: '#939db0', line: '#2c3544', mine: '#c2410c', theirs: '#243044' },
  { name: 'Teal Night', accent: '#2dd4bf', accent2: '#38bdf8', bg: '#071016', bg2: '#0e1a22', surface: '#15242e', text: '#e8f4f2', muted: '#8aa4ad', line: '#1e3340', mine: '#0f766e', theirs: '#1a3340' },
  { name: 'WhatsApp', accent: '#00a884', accent2: '#25d366', bg: '#0b141a', bg2: '#111b21', surface: '#202c33', text: '#e9edef', muted: '#8696a0', line: '#2a3942', mine: '#005c4b', theirs: '#1f2c34' },
  { name: 'Slack', accent: '#e01e5a', accent2: '#36c5f0', bg: '#1a1d21', bg2: '#222529', surface: '#2a2e33', text: '#f8f8f8', muted: '#ababad', line: '#3a3f45', mine: '#611f69', theirs: '#353b45' },
  { name: 'Nord', accent: '#88c0d0', accent2: '#a3be8c', bg: '#2e3440', bg2: '#3b4252', surface: '#434c5e', text: '#eceff4', muted: '#d8dee9', line: '#4c566a', mine: '#5e81ac', theirs: '#3f4a5c' },
  { name: 'Dracula', accent: '#bd93f9', accent2: '#ff79c6', bg: '#282a36', bg2: '#21222c', surface: '#44475a', text: '#f8f8f2', muted: '#6272a4', line: '#6272a4', mine: '#6272a4', theirs: '#3a3d4f' },
  { name: 'Ember', accent: '#f97316', accent2: '#fbbf24', bg: '#120b08', bg2: '#1c100c', surface: '#2a1710', text: '#fff7ed', muted: '#c4a484', line: '#3b2418', mine: '#ea580c', theirs: '#3a2218' },
  { name: 'Midnight', accent: '#60a5fa', accent2: '#a78bfa', bg: '#070b16', bg2: '#0d1424', surface: '#162036', text: '#e8eefc', muted: '#8b9bb8', line: '#243352', mine: '#1d4ed8', theirs: '#1e2a48' },
  { name: 'Moss', accent: '#4ade80', accent2: '#a3e635', bg: '#07140c', bg2: '#0d1c12', surface: '#15271b', text: '#ecfdf3', muted: '#86a891', line: '#1f3a28', mine: '#15803d', theirs: '#1a3224' },
  { name: 'Rose', accent: '#fb7185', accent2: '#f472b6', bg: '#14080e', bg2: '#1c0e14', surface: '#2a1520', text: '#fff1f5', muted: '#c4a0ad', line: '#3b2030', mine: '#e11d48', theirs: '#3a1c2a' },
  { name: 'Graphite', accent: '#a1a1aa', accent2: '#fafafa', bg: '#09090b', bg2: '#18181b', surface: '#27272a', text: '#fafafa', muted: '#a1a1aa', line: '#3f3f46', mine: '#52525b', theirs: '#323238' },
  { name: 'Ocean', accent: '#22d3ee', accent2: '#818cf8', bg: '#020617', bg2: '#0f172a', surface: '#1e293b', text: '#f8fafc', muted: '#94a3b8', line: '#334155', mine: '#0891b2', theirs: '#243447' },
  { name: 'Violet', accent: '#a78bfa', accent2: '#f472b6', bg: '#0c0a14', bg2: '#161225', surface: '#221c36', text: '#f5f3ff', muted: '#a39bb8', line: '#352d52', mine: '#7c3aed', theirs: '#2c2448' },
  { name: 'Crimson', accent: '#f43f5e', accent2: '#fb923c', bg: '#12080c', bg2: '#1c0f14', surface: '#2a161c', text: '#fff1f2', muted: '#c4a0a8', line: '#3f222c', mine: '#be123c', theirs: '#3a1e28' },
  { name: 'Aurora', accent: '#34d399', accent2: '#60a5fa', bg: '#061210', bg2: '#0c1c1a', surface: '#14302c', text: '#ecfdf5', muted: '#86a89e', line: '#1f433c', mine: '#059669', theirs: '#1a3834' },
  { name: 'Copper', accent: '#d97706', accent2: '#f59e0b', bg: '#120e08', bg2: '#1c160c', surface: '#2a2110', text: '#fffbeb', muted: '#b8a07a', line: '#3b3018', mine: '#b45309', theirs: '#3a2e18' },
  { name: 'Indigo', accent: '#818cf8', accent2: '#22d3ee', bg: '#080a16', bg2: '#101428', surface: '#1a2140', text: '#eef2ff', muted: '#9099b8', line: '#2a3358', mine: '#4f46e5', theirs: '#222c50' },
  { name: 'Cherry', accent: '#fb7185', accent2: '#fbbf24', bg: '#14080a', bg2: '#1e0e12', surface: '#2e161c', text: '#fff1f2', muted: '#c4a0a8', line: '#422028', mine: '#e11d48', theirs: '#3c1e28' },
  { name: 'Forest', accent: '#86efac', accent2: '#a3e635', bg: '#08140c', bg2: '#0f1e14', surface: '#183022', text: '#f0fdf4', muted: '#8eab96', line: '#264832', mine: '#16a34a', theirs: '#1e3a28' },
  { name: 'Neon', accent: '#22d3ee', accent2: '#a3e635', bg: '#05080f', bg2: '#0a1220', surface: '#122033', text: '#ecfeff', muted: '#7aa0b0', line: '#1e3448', mine: '#06b6d4', theirs: '#183044' },
];

export const LIGHT_PRESETS: ThemePreset[] = [
  { name: 'IMX Light', accent: '#e85d04', accent2: '#0f766e', bg: '#d7dde6', bg2: '#f7f8fb', surface: '#eef1f6', text: '#0c1118', muted: '#5b6778', line: '#c5ceda', mine: '#e85d04', theirs: '#e8eef6' },
  { name: 'Mist Teal', accent: '#0f766e', accent2: '#0284c7', bg: '#e8ecf1', bg2: '#ffffff', surface: '#f1f5f9', text: '#0f172a', muted: '#64748b', line: '#cbd5e1', mine: '#0f766e', theirs: '#e6f4f1' },
  { name: 'Soft Blue', accent: '#2563eb', accent2: '#7c3aed', bg: '#e8eef8', bg2: '#ffffff', surface: '#eef2ff', text: '#0f172a', muted: '#64748b', line: '#c7d2fe', mine: '#2563eb', theirs: '#e8eefc' },
  { name: 'Mint', accent: '#059669', accent2: '#0d9488', bg: '#e6f4ef', bg2: '#ffffff', surface: '#ecfdf5', text: '#052e16', muted: '#4d7c65', line: '#a7f3d0', mine: '#059669', theirs: '#e6f7ef' },
  { name: 'Sand', accent: '#c2410c', accent2: '#a16207', bg: '#ebe4d8', bg2: '#faf7f2', surface: '#f3eee6', text: '#1c140f', muted: '#7a6a5a', line: '#d6c7b4', mine: '#c2410c', theirs: '#f0e8dc' },
  { name: 'Lilac', accent: '#7c3aed', accent2: '#db2777', bg: '#e9e4f5', bg2: '#faf8ff', surface: '#f3effa', text: '#1e1233', muted: '#6b5f85', line: '#ddd6fe', mine: '#7c3aed', theirs: '#eee8fa' },
  { name: 'Sky', accent: '#0284c7', accent2: '#0891b2', bg: '#dceaf5', bg2: '#f5fbff', surface: '#e8f3fb', text: '#0c1929', muted: '#5a738a', line: '#bae6fd', mine: '#0284c7', theirs: '#e4f2fb' },
  { name: 'Paper', accent: '#334155', accent2: '#0f766e', bg: '#e2e8f0', bg2: '#ffffff', surface: '#f1f5f9', text: '#0f172a', muted: '#64748b', line: '#cbd5e1', mine: '#334155', theirs: '#e8edf4' },
  { name: 'Blush', accent: '#e11d48', accent2: '#db2777', bg: '#f3e8eb', bg2: '#fff7f9', surface: '#ffe4e6', text: '#4c0519', muted: '#9f1239', line: '#fecdd3', mine: '#e11d48', theirs: '#fce8ec' },
  { name: 'Citrus', accent: '#ca8a04', accent2: '#65a30d', bg: '#f3eedc', bg2: '#fffbeb', surface: '#fef3c7', text: '#422006', muted: '#854d0e', line: '#fde68a', mine: '#ca8a04', theirs: '#f7efd4' },
  { name: 'Lavender', accent: '#8b5cf6', accent2: '#ec4899', bg: '#ebe6f5', bg2: '#faf8ff', surface: '#f3effc', text: '#1e1033', muted: '#6b5f85', line: '#ddd6fe', mine: '#7c3aed', theirs: '#ebe4fa' },
  { name: 'Peach', accent: '#ea580c', accent2: '#f43f5e', bg: '#f0e6de', bg2: '#fff8f4', surface: '#ffedd5', text: '#431407', muted: '#9a3412', line: '#fed7aa', mine: '#ea580c', theirs: '#f8ebe2' },
  { name: 'Aqua', accent: '#0891b2', accent2: '#0d9488', bg: '#dceef3', bg2: '#f0fbfd', surface: '#e0f7fa', text: '#083344', muted: '#0e7490', line: '#a5f3fc', mine: '#0891b2', theirs: '#dff3f7' },
  { name: 'Matcha', accent: '#65a30d', accent2: '#16a34a', bg: '#e6eedc', bg2: '#f7fbef', surface: '#ecfccb', text: '#1a2e05', muted: '#4d7c0f', line: '#d9f99d', mine: '#65a30d', theirs: '#e8f2d8' },
  { name: 'Berry', accent: '#db2777', accent2: '#7c3aed', bg: '#f0e4ec', bg2: '#fff7fb', surface: '#fce7f3', text: '#500724', muted: '#9d174d', line: '#fbcfe8', mine: '#db2777', theirs: '#f8e6f0' },
  { name: 'Cloud', accent: '#64748b', accent2: '#0ea5e9', bg: '#e4e9f0', bg2: '#f8fafc', surface: '#f1f5f9', text: '#0f172a', muted: '#64748b', line: '#cbd5e1', mine: '#475569', theirs: '#e6ebf2' },
];
